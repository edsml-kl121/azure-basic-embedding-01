...
/*
// Comment out or remove these modules:
...
// Serverless endpoint - provide placeholder values since modules are commented out
output endpointName string = serverlessEndpointName
output marketplaceSubscriptionName string = marketplaceSubscriptionName
